...
import com.wisdom.dao.MimeTypeDAO;
...
public class MimeTypeConfig {
	...
	public static String MIME_OO_GRAPHICS = "application/vnd.oasis.opendocument.graphics";
	public static String MIME_OO_DATABASE = "application/vnd.oasis.opendocument.database";
	...
	public static String MIME_SVG_XML = "image/svg+xml";
