...
(function($) {
    ...
    $.fn.pagination.defaults = { total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 25, 50, 100], loading: false, buttons: null, onSelectPage: function(_1a7, _1a8) {
    }, beforePageText: "第", afterPageText: "共 {pages}页", displayMsg: "显示 {from} 到 {to} 条，共  {total} 条记录"
    };
})(jQuery);
(function($) {
    function _1a9(node) {
